export default function Imprint() {
	return <>
		...
		<p>This website is owned and operated by fast-content.com.</p>
		<p>Contact: meta-mapper@outlook.com</p>
		<p>This imprint also applies to our social media profiles on [List social media platforms].</p>
		<p><strong>Disclaimer:</strong></p>
		<p>The information provided on this website is for general informational purposes only. While we strive to keep
		...
		<p>Through this website you are able to link to other websites which are not under the control of [Your Name].
		...
		<p>Every effort is made to keep the website up and running smoothly. However, [Your Name] takes no
